...
export default defineEventHandler(async (event) => {
  let initUrl: string =
    "https://kudago.com/public-api/v1.4/movies/?page=1&page_size=10&fields=id,title,description,poster,budget,budget_currency,year,country,imdb_rating,director,stars";
  if (event.method === "GET") {
